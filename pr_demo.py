...
df_VFs_py = RvisualFields.vfpwgRetest24d2()
...
# td_single = td.iloc[0,ind_td_start:ind_td_end+1].to_numpy().astype(np.int16())
# R_float_vec = ro.vectors.FloatVector(td_single)
# # td_single_r= td_single 
# lib_vfprogression.plotTDvalues(R_float_vec)

# grdevices.dev_off()


tdp_values_singles = tdp.iloc[0,ind_td_start:ind_td_end+1].to_numpy().astype(np.float16())




Rvfprogression.plotTdProbabilities(tdp_values_singles, show=True, save=True, filename='tmp.png')
